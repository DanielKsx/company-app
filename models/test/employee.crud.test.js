...
describe('Reading data', () => {
    ...
    before(async () => {
        ...
        const testEmpTwo = new Employee({ firstName: 'Anna', lastName: 'Smith', department: 'HR' });
...
describe('Creating data', () => {
    ...
    it('should insert new document with "insertOne" method', async () => {
        const employee = new Employee({ firstName: 'Mike', lastName: 'Taylor', department: 'Sales' });
        await employee.save();
...
describe('Updating data', () => {
    ...
    it('should properly update one document with "updateOne" method', async () => {
        await Employee.updateOne({ firstName: 'John', lastName: 'Doe' }, { $set: { department: 'Finance' } });
        const updatedEmployee = await Employee.findOne({ firstName: 'John', lastName: 'Doe' });
        expect(updatedEmployee.department).to.be.equal('Finance');
    });
